...
p_1231 = diff.default(pnorm(q = d1231_b, mean = 198.67, sd = 41.31))
chisq_1231 = print_OE(d1231, prob = p_1231)
...
chisq_1233 = print_OE(o_1233, prob = p_1233)
...
# .. that the two populations are homogeneous in migraine (p = .722)
